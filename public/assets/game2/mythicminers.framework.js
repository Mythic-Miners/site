...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_GetFakemodTimeInSeconds")) {
 Object.defineProperty(Module["ready"], "_GetFakemodTimeInSeconds", {
  configurable: true,
  get: function() {
   abort("You are getting _GetFakemodTimeInSeconds on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_GetFakemodTimeInSeconds", {
  configurable: true,
  set: function() {
   abort("You are setting _GetFakemodTimeInSeconds on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
function _sendMessageToReact(eventName, data) {
 dispatchReactUnityEvent(UTF8ToString(eventName), UTF8ToString(data));
}
