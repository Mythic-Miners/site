...
export default function TokensPage() {
  ...
  if (isConnected && holdings && 'error' in holdings) {
    return (
      <div className="min-h-screen bg-linear-to-b from-blue-950 to-gray-900 p-4">
        <button
          onClick={() => router.back()}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h3 className="max-w-3xl text-center text-2xl font-bold text-gray-300 mb-10 mt-4">
              {t('tokensPage.didNotParticipate')}
            </h3>
            <AuthButton />
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-blue-950 to-gray-900 p-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {isConnected && holdings && 'data' in holdings ? (
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg border border-neutral-950">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Skeleton
                    className="rounded-sm bg-blue-500 before:bg-gradient-to-r before:from-blue-500 before:via-[#ffffff40] before:to-blue-500"
                    isLoaded={!isLoading}
                  >
                    <p className="text-2xl font-bold text-blue-400">
                ...
                <p className="text-xs text-gray-400 mb-0">
                  {t('tokensPage.claimableDate', {
                    date: new Intl.DateTimeFormat(language, {
                      dateStyle: 'medium',
                      timeStyle: 'short',
                    }).format(new Date(holdings?.data.claimable.nextClaim)),
                  })}
                </p>
                <button
                  disabled
                  className="mt-4 disabled:opacity-50 disabled:grayscale bg-amber-500 text-black font-bold py-2 px-4 rounded-md hover:bg-amber-600 transition-colors border-2 border-neutral-950 w-full"
                >
                  {t('tokensPage.claim')}
                </button>
              </div>
